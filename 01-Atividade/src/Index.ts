...
class Index {
    ...
    constructor() {
        ...
        this.produto1 = new Produto(101, "Notebook", 4);
        this.telefone1 = new Telefone("42", 991272342, "Celular");
        this.endereco1 = new Endereco("Jasmim", 486, "Telêmaco Borba", "Paraná");
        this.cliente1 = new Cliente("Victor", 10180944902, 182003, "masculino", this.endereco1, [this.telefone1]);
        this.venda1 = new Venda(1, 8042024, this.cliente1, [this.produto1]);
...
console.log("Total: " + index.venda1.calcularTotal());